...
OUTPUT_DIR = "data" # This directory will now primarily store the JSON, and temporarily the PDFs if they're deleted right after.
        ...
        with zipfile.ZipFile(local_zip_filepath, 'r') as zf:
            ...
            for pdf_name_in_zip in pdf_filenames_in_zip:
                ...
                if MIN_TOKENS <= token_count <= MAX_TOKENS: # Added MAX_TOKENS check
                    ...
                    # --- MODIFICATION START ---
                    # Instead of saving the PDF, we will process it and then can optionally delete it
                    # if you decide to save it temporarily for any reason.
                    # For this request, we are removing the saving of the PDF to disk.
                    # The `pdf_bytes` are in memory and have been processed.
